...
| --- | --- | ---: | --- |
| Eyebrow | Approval before client handoff | 4 | pass |
| H1 | Approve quotes and invoices before they go out. | 8 | pass |
| Intro | For small agencies and trade teams that need a second reviewer before a client gets a quote or invoice. | 19 | pass |
| Demo action | Try it with sample data | 6 | pass |
| Demo outcome | Loads three sample gates. | 4 | pass |
| Demo outcome | Nothing is saved. | 3 | pass |
...
| Footer | Built by Param Factory · v1.0.5 · build repair-7 | 8 | pass |

## Terminology

| Concept | One term used |
| --- | --- |
| Individual work item | gate |
| Source file | PDF |
| Link-based source | share link |
| Person receiving the document | client |
| Person checking before handoff | reviewer |
| Final user-controlled email action | email draft / handoff |
